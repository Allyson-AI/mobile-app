...
const H1 = React.forwardRef(({ className, asChild = false, ...props }, ref) => {
  const Component = asChild ? Slot.Text : RNText;
  return (
    <Component
      role="heading"
      aria-level="1"
      className={cn(
        "web:scroll-m-20 text-4xl text-zinc-400 font-extrabold tracking-tight lg:text-5xl web:select-text",
        className
      )}
      ref={ref}
      {...props}
...
H1.displayName = "H1";
const H2 = React.forwardRef(({ className, asChild = false, ...props }, ref) => {
  const Component = asChild ? Slot.Text : RNText;
  return (
    <Component
      role="heading"
...
H2.displayName = "H2";
const H3 = React.forwardRef(({ className, asChild = false, ...props }, ref) => {
  const Component = asChild ? Slot.Text : RNText;
  return (
    <Component
      role="heading"
...
H3.displayName = "H3";
const H4 = React.forwardRef(({ className, asChild = false, ...props }, ref) => {
  const Component = asChild ? Slot.Text : RNText;
  return (
    <Component
      role="heading"
